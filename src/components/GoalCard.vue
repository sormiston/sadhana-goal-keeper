      ...
      <div class="goal-time-info">
        <div>
          <div v-if="!this.noDuration">
            ...
            <span v-if="this.durationHours != null && this.durationHours > 0"
              >{{ this.durationHours }} hours
            </span>
            <span
              v-if="this.durationMinutes != null && this.durationMinutes > 0"
              >{{ this.durationMinutes }} minutes</span
            >
          </div>
          <div>
  ...
  computed: {
    ...
    goalCycle() {
      ...
      switch (this.cycle) {
        ...
        case "Monthly":
          cycle =
            this.cycleDayOfMonth + this.cycleOnceMonthlyDay + "of each month";
          break;
        default:
          cycle = this.cycle;
          break;
